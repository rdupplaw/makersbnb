...
describe Listing do
  ...
  describe '::all' do
    it 'returns an array of Listing objects' do
      listing = Listing.create(name: 'test name 1', description: 'test description 1', price: 89.99, owner_id: mock_user['id'],
                               start_date: '2021-05-27', end_date: '2021-05-28')
      Listing.create(name: 'test name 2', description: 'test description 2', price: 99.99, owner_id: mock_user['id'],
                     start_date: '2021-05-27', end_date: '2021-05-28')
      Listing.create(name: 'test name 3', description: 'test description 3', price: 79.99, owner_id: mock_user['id'],
                     start_date: '2021-05-27', end_date: '2021-05-28')
      ...
      expect(result.first.owner_id).to eq(mock_user['id'])
    end
  end

  describe '::create' do
    it 'creates a new listing' do
      listing = Listing.create(name: 'test name', description: 'test description', price: 99.99, owner_id: mock_user['id'],
                               start_date: '2021-05-27', end_date: '2021-05-28')
      ...
      expect(Listing.all.first.owner_id).to eq(mock_user['id'])
